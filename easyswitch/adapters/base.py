...
class BaseAdapter(abc.ABC):
    ...
    def get_client(self) -> HTTPClient:
        ...
        if not self.client:
            ...
            return HTTPClient(
                ...
                default_headers={**self.get_headers(), "User-Agent": USER_AGENT},
    ...
    def validate_transaction(self, transaction: TransactionDetail) -> bool:
        ...
        validate_currency(transaction.currency, self.SUPPORTED_CURRENCIES)

        # Validate the phone number
        validate_phone_number(transaction.customer.phone_number)
        return True
